      ...
      <div className={styles.container}>
        ...
        <div className={styles.topSection}>
          ...
          <div className={styles.brandColumn}>
            <Link to="/" className={styles.brand} aria-label="UFA Home">
              <div className={styles.logoWrapper}>
                <img src={logo} alt="Unique Focus Association Logo" className={styles.logoImage} />
              </div>
              <div className={styles.brandText}>
                <span className={styles.companyAcronym}>UFA</span>
                <span className={styles.companyName}>Unique Focus Association</span>
              </div>
            </Link>
          ...
          <div className={styles.linkColumn}>
            ...
            <div className={styles.contactList}>
              <a href="mailto:uniquefocusassociation@gmail.com" className={styles.contactItem}>
        ...
        <div className={styles.bottomSection}>
          <p className={styles.copyright}>
            &copy; {currentYear} Unique Focus Association (UFA). All rights reserved.
          </p>
          <p className={styles.heartText}>
            Built with <Heart size={14} className={styles.heartIcon} /> for Kenya's Youth
          </p>
        </div>
      </div>
    </footer>
